def solution(A):
    ...
    for each in range(len(A)):
        if A[each] == '1' or A[each] == '[1' or A[each] == '1]':
            a = A.count('6') * 2 + A.count('[6') * 2 + A.count('6]') * 2
