'''
E:\승현\Github\python_enhanced\newspaper_reader\reader.py
'''
import itertools
paper = open("E:/승현/Github/python_enhanced/newspaper_reader/eng_news_2016_10K-sentences.txt", "r", encoding = "utf8")
